...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15167
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15168
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 25167
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 25168
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 15167
	%{_sbindir}/semanage port -d -p tcp 15168
	%{_sbindir}/semanage port -d -p tcp 25167
	%{_sbindir}/semanage port -d -p tcp 25168
