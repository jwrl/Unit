...
"""Verify that starting unit with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start unit with -h for help text")
        ...
        self.log.info("Start unit with -version for version information")
