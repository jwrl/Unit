...
* unit.conf: contains configuration settings for unitd or unit-qt
* unitd.pid: stores the process id of unitd while running
...
* debug.log: contains debug information and general logging generated by unitd or unit-qt
