...
Then, to tunnel a SSL connection on 215167 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 215167 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /unitrpc>
        ProxyPass http://127.0.0.1:15167/
        ProxyPassReverse http://127.0.0.1:15167/
